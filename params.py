...
EQUIPMENT_COST = 102      # Total equipment cost in million $
INSTALLATION_FACTOR = 3.0     # Installation cost = equipment cost * this factor
LAND_COST = 5.0             # Land cost in million $

# Operational Parameters
CAPACITY_FACTOR = 1  # How often the plant runs (85%)
HOURS_PER_YEAR = 8760
EFFICIENCY = 0.40 # Efficiency of the generators (45%)

# Operating Costs (annual, in base year dollars)
OM_COST_ANNUAL =2.0           # O&M cost in million $ per year
...
CONNECTION_INSTALLATION_COST = 15 # MIL$ - for grid connection equipment
GRID_ELECTRICITY_RATE = 0.06   # $ per kWh from grid
GRID_DEMAND_CHARGE = 10.0      # $ per kW per month

# Financial Parameters
INFLATION_RATE = 0.05    # 3% annual inflation affecting all future costs
DISCOUNT_RATE = 0.063     # 8% discount rate for NPV calculations
